...
1. `cargo run -p panopticon-tui --bin panopticon -- --human --help`
- Result: informational pass (help text emitted)
- Evidence: `/tmp/panopticon_readme_verify_2026-02-18/help-human.txt`

2. `cargo run -p panopticon-tui --bin panopticon -- tour fixtures/large-stress.jsonl --stress --output-dir /tmp/.../tour-a`
- Result: pass
- Evidence: `/tmp/panopticon_readme_verify_2026-02-18/tour-a.txt`

3. `cargo run -p panopticon-tui --bin panopticon -- tour fixtures/large-stress.jsonl --stress --output-dir /tmp/.../tour-b`
- Result: pass
- Evidence: `/tmp/panopticon_readme_verify_2026-02-18/tour-b.txt`

4. Tour determinism hash compare
- Result: pass
- Evidence: `/tmp/panopticon_readme_verify_2026-02-18/hash-compare.txt`
...
- Result: pass
- Evidence: `/tmp/panopticon_readme_verify_2026-02-18/export-success.txt`
...
- Evidence: `/tmp/panopticon_readme_verify_2026-02-18/export-refused.txt`
...
- Evidence: `/tmp/panopticon_readme_verify_2026-02-18/view-smoke.txt`
...
- Evidence: `/tmp/panopticon_readme_verify_2026-02-18/metrics-summary.txt`
